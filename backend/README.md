...
## Project Structure
    ...
    ├── testapiautoteammemb_98042  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_98042`
...
2. Clone this repo and `cd testapiautoteammemb_98042`
